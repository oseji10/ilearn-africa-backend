                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        <p>We are pleased to inform you that your recent application for <b>{{$course_name}}</b> with iLearn360 Africa has been approved and you can commence your trainining immediately.</p>
                        ...
                        <table class="body-sub" role="presentation">
                          <tr>
                            <td>
                              <p class="f-fallback sub">Please download the attached admission letter for your documentation.</p>
