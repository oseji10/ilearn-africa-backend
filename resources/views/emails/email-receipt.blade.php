...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <span class="preheader">This is a receipt for your recent purchase on {{$transaction_date}}. No payment is due with this receipt.</span>
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Hi {{$firstname}},</h1>
                        <p>Thanks for paying for {{$course_name}}. This email is the receipt for your payment. No payment is due.</p>
                        ...
                        <table class="purchase" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                            <td>
                              <h3>Transaction ID: {{$transaction_reference}}</h3></td>
                            <td>
                              <h3 class="align-right">{{$transaction_date}}</h3></td>
                          </tr>
                          <tr>
                            <td colspan="2">
