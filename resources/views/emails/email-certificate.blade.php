                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        <p>We are pleased to inform you that your certificate for <b>{{$course_name}}</b> with iLearn Africa is now ready. The certificate is herewith attcahed</p>
                        ...
                        <table class="body-sub" role="presentation">
                          <tr>
                            <td>
                              <p class="f-fallback sub">Please download the attached certificate for your documentation.</p>
