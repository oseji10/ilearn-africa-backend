...
<head>
    ...
    <title>iLearn360 Africa Test Report Form</title>
    <style>
...
<body>
    <!-- <div class="header">Test Report Form</div> -->
     <!-- <img src="{{Storage::url('/ilearn-logo.png')}}" alt="iLearn360 Africa Logo" align="left" width="200px"><br/><br/><br/><br/><br/><br/> -->
     <img src="{{ public_path('images/ilearn-logo.png') }}" alt="iLearn360 Africa Logo" width="150px">
...
<td>
    {{
        $results->obtainable_score > 0
        ? round(($results->total_score / $results->obtainable_score) * 100, 2)
        : 0
    }}%
</td>
...
<td>
    {{
        $results->obtainable_score > 0 &&
        (($results->total_score / $results->obtainable_score) * 100) >= 50
        ? 'PASS'
        : 'RESIT'
    }}
</td>                
