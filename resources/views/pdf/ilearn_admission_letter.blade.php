...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Following a comprehensive assessment of your application, encompassing your academic qualifications and pertinent credentials, we are delighted to convey that the board of iLearn 360 Africa has granted you admission into her <b style="text-transform:uppercase;">{{$course_name}} program.</b></p>
    ...
    <footer class="footer">
        ...
        <table  width="80%" style="top:15px; padding-left: -20px">
            <tr>
                ...
                <td align="center">admin@ilearn360africa.com</td>
                <td width="40%">Suite 009 Nawa Complex Kado, Abuja,
                Nigeria</td>
